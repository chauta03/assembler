...
{       
        ...
        return -1;      /* stub code so function will compile. */
}
   ...
   */
{
        ...
        if ( findLabelAddr( table, label ) != -1 )  /* REAL CODE MISSING ! */
        {
        ...
        /* Add the label, which is add (labelDuplicate, progCounter) pair */
        /* CODE MISSING ! */
